                        ...
                        <div
                            ...
                            <div>
                                ...
                                <p class="text-sm text-gray-600 dark:text-neutral-400">
                                    Manage history and view all users.
                                </p>
                            </div>
                            ...
                            <tbody class="divide-y divide-gray-200 dark:divide-neutral-700">
                                @forelse ($this->users() as $user_key => $user)
                                    <tr wire:key="{{ $user_key }}">
                                        ...
                                        <td class="size-px whitespace-nowrap">
                                            <div class="px-6 py-3">
                                                <span class="text-sm text-gray-500 dark:text-neutral-500">{{ $user->deleted_at->diffForHumans() }}</span>
                                            </div>
                                        </td>
                                        <td class="size-px whitespace-nowrap">
                                            <div class="px-6 py-1.5">
                                                <a wire:click="restore({{ $user->id }})" href="#"
